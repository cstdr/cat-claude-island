...
struct ClaudeDirPickerRow: View {
        ...
        VStack(spacing: 0) {
            ...
            Button {
                ...
                HStack(spacing: 10) {
                    ...
                    Text("Claude Directory".localized)
    ...
    private var displayValue: String {
        isCustom ? shortenedPath(currentValue) : "Auto-detect".localized
    }
    ...
    private func openFolderPicker() {
        ...
        panel.title = "Choose Claude Config Directory".localized
        panel.message = "Select the folder Claude Code uses (typically ~/.claude or ~/.config/claude).".localized
